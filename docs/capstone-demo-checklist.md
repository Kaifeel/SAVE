...
| Google 로그인 | Not run | |
| 카탈로그 / 물품 상세 | Not run | |
| 카메라 촬영 / 갤러리 다중 선택 / 사진 등록 | Not run | 최대 5장, 등록 후 상세 이미지 확인 |
| 상세 사진 좌우 이동 / 공유 | Not run | 사진이 잘리지 않고 순서와 개수가 맞는지 확인 |
| 채팅하기 / 대여 요청 | Not run | 네이티브 날짜·시간 선택과 예상 금액 확인 |
| 대여 승인·시작·반납 / 후기 | Not run | 계정 A/B 역할별 버튼 확인 |
...
| 홈 / 탐색 / 물품 상세 | Not run | |
| 카메라 촬영 / 갤러리 선택 / 사진 등록 | Not run | 등록 후 상세 이미지 확인 |
| 상세 사진 좌우 이동 / 공유 | Not run | 시스템 공유 화면 확인 |
| 채팅하기 / 대여 요청 | Not run | iOS 날짜·시간 선택 확인 |
| 대여 내역 / 상태 처리 / 후기 | Not run | 계정 A/B 역할별 확인 |
